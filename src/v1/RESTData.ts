...
export const RESTData = (config: {
  ...
  return {
    ...
    GetDiscountAvailabilityForCinema: async (
      cinemaId: string,
    ): Promise<{
      success: boolean;
      message: string;
    ...
    GetSeasonPassDealFilmSessions: async (
      cinemaId: string,
      promotionId: string,
    ): Promise<{
      success: boolean;

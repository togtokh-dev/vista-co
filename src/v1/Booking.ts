...
export const Booking = (config: {
  ...
  return {
    ...
    GetBookingDetails: async (requestBody: {
    ...
    CancelBooking: async (requestBody: {
      CinemaId: string;
    ...
    MarkBookingAsCollected: async (requestBody: {
      CinemaId: string;
      BookingNumber: number;
      ItemsPrinted?: number;
      ...
      try {
        ...
        console.error(
          "Mark booking as collected failed",
          error?.response?.data,
        );
        return {
          success: false,
    ...
    RefundBooking: async (requestBody: {
      BookingNumber: number;
      CinemaId: string;
    ...
    SearchBooking: async (requestBody: {
    ...
    MarkBookingAsPaid: async (requestBody: {
    ...
    StartPaymentForUnpaidBooking: async (requestBody: {
    ...
    UpdateUnpaidBooking: async (requestBody: {
